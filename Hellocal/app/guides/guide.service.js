...
var GuideService = (function () {
    function GuideService(_http) {
        this._http = _http;
        this._guideUrl = 'http://localhost:3000/api/guides';
    }
    ...
    GuideService.prototype.getGuide = function (userId) {
        return this.getGuides()
            .map(function (guides) { return guides.find(function (g) { return g.userId === userId; }); });
    };
